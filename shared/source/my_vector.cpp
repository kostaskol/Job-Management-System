#include <stdexcept>
#include <mystring.h>
#include <../../jms-coord/include/job.h>
#include <pool.h>
...
template <typename T>
my_vector<T>::my_vector(int capacity) : _size(0), _capacity(capacity), _last(0) {
...
template class my_vector<job>;
template class my_vector<pipe_manager>;
template class my_vector<pool>;
